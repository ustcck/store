package cn.ustcdata.store.web.rest;

import cn.ustcdata.store.StoreApp;

import cn.ustcdata.store.domain.Product;
import cn.ustcdata.store.repository.ProductRepository;
import cn.ustcdata.store.repository.search.ProductSearchRepository;
import cn.ustcdata.store.web.rest.errors.ExceptionTranslator;
...
import static cn.ustcdata.store.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductResourceIntTest {
     ...
     *
     * @see cn.ustcdata.store.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
